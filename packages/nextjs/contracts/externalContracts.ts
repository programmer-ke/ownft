...
const externalContracts = {
  11155111: {
    Ownft: {
      address: "0x5a67d5045A147c17903c6f6e6EcbA796aE6E3D33",
      abi: [
        ...
        },
        {
          ...
          inputs: [
            { name: "tokenId", type: "uint256", indexed: true, internalType: "uint256" },
            { name: "imageUri", type: "string", indexed: true, internalType: "string" },
            ...
            { name: "rawImageUri", type: "string", indexed: false, internalType: "string" },
          ],
          anonymous: false,
        },
        {
        ...
        { type: "error", name: "Ownft__FundsTransferFailed", inputs: [] },
        { type: "error", name: "Ownft__InvalidDescription", inputs: [] },
        { type: "error", name: "Ownft__InvalidImageUri", inputs: [] },
        {
          type: "error",
          name: "Ownft__InvalidRoyaltyBps",
          inputs: [
            { name: "actual", type: "uint96", internalType: "uint96" },
            { name: "max_allowed", type: "uint96", internalType: "uint96" },
          ],
        },
        { type: "error", name: "Ownft__NotTokenOwner", inputs: [] },
        {
          type: "error",
